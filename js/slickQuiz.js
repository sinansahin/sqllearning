(function($){
    ...
    $.slickQuiz = function(element, options) {
        ...
        var defaults = {
            checkAnswerText:  'Kontrol Et!',
            nextQuestionText: 'İleri &raquo;',
            backButtonText: '',
            randomSort: false,
            ...
            setupQuiz: function() {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<div class="questionCount">Soru <span class="current">' + count + '</span> / <span class="total">' + questionCount + '</span></div>');
